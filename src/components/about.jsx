        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have dig into research on Deep Learning focusing on NLP and BERT</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>Graphic Dessign & Filmmaking</h3>
                    <p>I am an Indie Filmmaker, Photographer and Graphic Designer with past experience in Advertisements and Marketing</p>
                </div>
                </div>
            </div>
            {/*
